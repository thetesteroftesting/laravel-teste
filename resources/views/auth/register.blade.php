                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                            ...
                            <div class="form-group row">
                                <label for="second_name" class="col-md-4 col-form-label text-md-right">{{ __('second_name') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="place_of_employment" class="col-md-4 col-form-label text-md-right">{{ __('place_of_employment') }}</label>

                                <div class="col-md-6">
                                    <select name="place_of_employment" id="place_of_employment" type="text" class="custom-select custom-select-lg mb-3 {{ $errors->has('place_of_employment') ? ' is-invalid' : '' }} " required autofocus>
                                        @foreach($placesOfEmployment as $key => $placeOfEmployment)
                                            <option value="{{ $placeOfEmployment->id }}">{{ $placeOfEmployment->name }}</option>
                                        @endforeach
                                    </select>
